        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto w-50 nav-justified">
                    <li class="nav-item {{ Request::is('kitsuke/reservations*') ? 'active' : '' }}">
                    <!-- <li class="nav-item"> -->
                        <a class="nav-link" href="{{ route('reservations.index') }}">予約</span></a>
                    </li>
                    <li class="nav-item {{ Request::is('kitsuke/masters*') ? 'active' : '' }}">
                    <!-- <li class="nav-item"> -->
                        <a class="nav-link" href="{{ route('masters.index') }}">講師</a>
                    </li>
                    <li class="nav-item {{ Request::is('kitsuke/connectors*') ? 'active' : '' }}">
                    <!-- <li class="nav-item"> -->
