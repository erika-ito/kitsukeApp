            ...
            <div class="reservation-create-wrapper border bg-white px-5 py-4">
                ...
                <div id="reservation_form_1" class="pt-3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-2">
                            <input type="text" class="form-control" name="master_1" id="master_1" value="{{ old('master_1') }}" placeholder="1人目">
                        </div>
                        <label for="master_2" class="col-2 offset-2"></label>
                        <div class="col-2">
                            <input type="text" class="form-control" name="master_2" id="master_2" value="{{ old('master_2') }}" placeholder="2人目">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="master_3" class="col-2 offset-1"></label>
                        <div class="col-2">
                            <input type="text" class="form-control" name="master_3" id="master_3" value="{{ old('master_3') }}" placeholder="3人目">
                        </div>
                        <label for="master_4" class="col-2 offset-2"></label>
                        <div class="col-2">
                            <input type="text" class="form-control" name="master_4" id="master_4" value="{{ old('master_4') }}" placeholder="4人目">
                        </div>
                    </div>
                    <div class="form-group row">
